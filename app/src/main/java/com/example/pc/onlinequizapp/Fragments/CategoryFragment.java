...
import com.example.pc.onlinequizapp.Activities.Start;
...
import com.example.pc.onlinequizapp.Model.Category;
import com.example.pc.onlinequizapp.R;
import com.example.pc.onlinequizapp.ViewHolder.CategoryViewHolder;
    ...
    private void loadCategories() {
        ...
        firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Category, CategoryViewHolder>(
            ...
            protected void populateViewHolder(CategoryViewHolder viewHolder, final Category model, final int position) {
                ...
                fabChildClickMethods fabChildClickMethod = new fabChildClickMethods(getActivity());
                viewHolder.fabImage.setOnClickListener(fabChildClickMethod);
                viewHolder.fabText.setOnClickListener(fabChildClickMethod);
                viewHolder.fabSound.setOnClickListener(fabChildClickMethod);

                viewHolder.setItemClickListener(new ItemClickListener() {
                    @Override
                    public void Onclick(View view, int position, boolean isLongClick) {
                        Intent startGame = new Intent(getActivity(), Start.class);
                        Common.categoryId = firebaseRecyclerAdapter.getRef(position).getKey();
